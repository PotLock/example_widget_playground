...
<body>
  ...
  <script 
    async 
    src="https://purge.jsdelivr.net/gh/PotLock/cross-chain-widget/dist/widget.js" 
...
function App() {
  useEffect(() => {
    const scriptSrc = 'https://purge.jsdelivr.net/gh/PotLock/cross-chain-widget/dist/widget.js';
